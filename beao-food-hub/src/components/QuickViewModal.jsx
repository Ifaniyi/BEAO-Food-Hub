...
import { X, Star, Minus, Plus, ShoppingCart, Tag } from "lucide-react";
...
export default function QuickViewModal({ product, onClose }) {
  ...
  // Extract base price (first price in range)
  const basePrice = product.basePrice || 8000;
              ...
              <div className="flex-1 p-7 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mb-3 leading-relaxed">
                    {product.description || "Fresh and authentic Nigerian product, carefully sourced and quality checked."}
                  </p>
                ...
                <div className="flex gap-3">
                  <button className="flex-1 bg-[#1a6b3c] hover:bg-[#155a32] text-white font-semibold py-3 rounded-xl flex items-center justify-center gap-2 transition-colors">
                    <ShoppingCart size={17} />
                    Add to Cart
                  </button>
                  <button className="px-5 bg-[#25d366] hover:bg-[#20b858] text-white font-semibold py-3 rounded-xl flex items-center justify-center gap-2 transition-colors">
